...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("azure-agents");
			params.setVersion("0.4.0");
			params.setValue(Uint8Array.from(atob("ewogICJtb2R1bGUiOiAiQXp1cmUvYXZtLXB0bi1jaWNkLWFnZW50cy1hbmQtcnVubmVycy9henVyZXJtIiwKICAidmVyc2lvbiI6ICIwLjQuMCIsCiAgInBhY2thZ2VOYW1lIjogImF6dXJlLWFnZW50cyIKfQ=="), c => c.charCodeAt(0)));

			const req = new resproto.RegisterPackageRequest();
			req.setName("terraform-module");
			req.setVersion("0.1.8");
			req.setDownloadUrl("");
